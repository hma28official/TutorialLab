...
public class Preferences {
    /* Pendeklarasian key-value berupa String, sebagai variabel penyimpan
    data, sehingga setiap data memiliki key yang berbeda satu sama lain */
    static final String KEY_USER_TEREGISTER ="user", KEY_PASS_TEREGISTER="pass";
    static final String KEY_USERNAME_SEDANG_LOGIN = "Username_logged_in";
    static final String KEY_STATUS_SEDANG_LOGIN = "Status_logged_in";

    /* Mendeklarasikan Shared Preferences dengan paramater context */
    private static SharedPreferences getSharedPreference(Context context){
        return PreferenceManager.getDefaultSharedPreferences(context);
    }

    /* Mendeklarasikan Edit Preferences dan mengubah data
    KEY_USER_TEREGISTER dengan parameter username */
    ...
    /* Mendeklarasikan Edit Preferences KEY_PASS_TEREGISTER dengan
    parameter password */
    ...
    /* Mendeklarasikan Edit Preferences KEY_USERNAME_SEDANG_LOGIN dengan
    parameter username */
    ...
    /* Mendeklarasikan Edit Preferences KEY_STATUS_SEDANG_LOGIN dengan
    parameter status */
    ...
    /* Mendeklarasikan Edit Preferences dan menghapus data, sehingga
    menjadikannya bernilai default. Khusus untuk data yang memiliki key
    KEY_USERNAME_SEDANG_LOGIN dan KEY_STATUS_SEDANG_LOGIN */
